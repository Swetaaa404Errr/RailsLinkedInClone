...
ActiveRecord::Schema.define(version: 2023_03_01_054329) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.index ["user_id", "job_navigation_id"], name: "index_likes_on_user_id_and_job_navigation_id", unique: true
