...
ActiveRecord::Schema.define(version: 20_230_222_181_714) do
  ...
  create_table 'applies', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_applies_on_user_id_and_created_at'
  ...
  create_table 'connections', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_connections_on_user_id_and_created_at'
